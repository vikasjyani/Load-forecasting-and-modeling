...
class LoadProfileService(ServiceCacheMixin):
    """
    ...
    def __init__(self, project_path: str):
        ...
        self.__init_cache__(cache_ttl=300)  # 5 minutes
                ...
                if os.path.exists(csv_path):
                    ...
                    try:
                        ...
                        profile['data_preview'] = {
                            ...
                            'date_range': {
                                'start': df['ds'].min() if 'ds' in df.columns else None,
                                'end': df['ds'].max() if 'ds' in df.columns else None
                            }
                        }
                    except Exception:
                        pass
    ...
    def get_profile_detailed_data(self, profile_id: str) -> Dict[str, Any]:
        ...
        try:
            ...
            # Cache result
            self._set_cached(cache_key, detailed_data)
    ...
    def _clear_template_cache(self):
        ...
        self._clear_cache_pattern('template')
        self._clear_cache_pattern('base_years')
    
    def _clear_profile_cache(self):
        """Clear profile-related cache entries"""
        self._clear_cache_pattern('profile_detail')
